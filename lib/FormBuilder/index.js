...
var _l = Debug._l;
var _i = Debug._i;
var getMsg = require("../i18n").get, PageScript = require("../PageScript"), getProp = require("../AppProperties").get;

//var v = require('../Validator').getInstance();
var Constants = require("./Constants"), ValidationMsgs = Constants.ValidationMsgs;
var viewLib = require("../viewLibs/lib"), DateFormatter = require("../Utils/dateformat"),
...
function createInput(field, vals) {
    ...
    if (val) {
        switch (field.type) {
            ...
            case "date":
                try {
                    val = DateFormatter(new Date(val), DATE_FORMAT);
                } catch (e) {
                }
    ...
    switch (field.type) {
        case "date":
            ...
            var jqueryDatePickerInit = '$("#' + field.id + '" ).datepicker' +
                '({dateFormat:\'' + JQUERY_UI_DATE_FORMAT + '\',changeMonth: true,   changeYear: true });';
            PageScript.add(jqueryDatePickerInit);
            break;
        case "submit":
        ...
        case "cancel":
            ...
            field.type = "button";
            PageScript.add("Rocket.Util.onFormCancel('" + field.id.split("_")[0] + "','" +
                field.id + "');");
            break;
