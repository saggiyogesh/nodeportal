...
var _l = Debug._l;
var _i = Debug._i;
var getMsg = require("../i18n").get, PageScript = require("../PageScript"),
...
function value(vals, name) {
    return vals && vals[name] ? vals[name] : "";
}


function createInput(app, field, vals) {
    ...
    switch (field.type) {
        case "date":
            ...
            PageScript.add(app, jqueryDatePickerInit, "jqueryui");
            break;
        case "submit":
        ...
        case "cancel":
            ...
            field.type = "button";
            PageScript.add(app, "Rocket.Util.onFormCancel('" + field.id.split("_")[0] + "','" +
                field.id + "');", "util");
            break;
...
exports.SettingsDynamicForm = function (app, namespace, formObj, locale, vals, mode) {
    var dummyReq = {
        attrs: {},
        app: app,
    ...
    return process(app, locale, formObj, namespace, vals, mode);
};
function process(app, locale, formObj, namespace, vals, mode, formValidation) {
    ...
    formObj.fields.forEach(function (field) {
        ...
        switch (field.type) {
            ...
            case "radio":
                ...
                break;
            default:
                fieldHTML = createInput(app, field, vals);
        }
 ...
 */
var DynamicForm = exports.DynamicForm = function (req, formObj, locale, mode) {
    var namespace = getNamespace(req);
    var vals = getValsFromReq(req, namespace);
    var form = _.clone(formObj.form);
    formObj.form = form;
    var action = form.action;
    form.action = viewLib.getURL(req, action);

    var formValidation = req.attrs.formValidation;
    return process(req.app, locale, formObj, namespace, vals, mode, formValidation);
};
