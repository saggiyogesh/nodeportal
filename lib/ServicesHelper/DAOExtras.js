...
function DAOExtras(Service) {
    ...
    Service.populateModelAndUpdate = function (params, otherValues, keyMapObj, next) {
        var modelValues = populateModel(params, otherValues, keyMapObj);
        this.update(modelValues, next);
    };

    Service.populateModelAndSave = function (params, otherValues, keyMapObj, next) {
        var modelValues = populateModel(params, otherValues, keyMapObj);
