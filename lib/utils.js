...
//    var msg = new Date().toUTCString() + " : " + fileStr;
    process.env.WORKER_ID && (msg = "Worker: " + process.env.WORKER_ID + " : " + msg);
    console.log(msg + " :: " + str);
}
 ...
 * var a1 = [1,2,3];
 * var a2 = [1,2,4];
 * matchArray(a1,a2) => false
 *
 * @param array1 {Array}
 * @param array2 {Array}
 */
exports.matchArray = function (array1, array2) {
    return _.every(array2, function (e) {
        return _.include(array1, e)
    });
};
...
var servicesPath = realPath(appPath, "services");
...
/**
 * Returns services real path
 * @returns {String}
 */
exports.getServicesPath = function () {
    return servicesPath;
};
...
/**
 * Returns first letter capitalize of input string
 * @param {String} string
 * @returns {String}
 */
...
/**
 * Copy properties of src to dest object
 * @param {Object} src
 * @param {Object} dest
 */
exports.copyObject = function (src, dest) {
