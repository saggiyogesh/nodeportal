...
var plugins = require('./plugins'), Step = require('step'), DBActions = require("./DBActions"),
    ...
    PluginInstanceHandler = require("../lib/PluginInstanceHandler"),
...
var addClientScripts = exports.addClientScripts = function (req, pluginId) {
    var pluginClientScriptURL = "/static/?type=plugin&path=" + pluginId + "/" + pluginId + ".js"
