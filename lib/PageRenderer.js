...
var plugins = require('./plugins'), DBActions = require("./DBActions"),
...
var PermissionError = require('./permissions/PermissionError'),
...
//            Debug._li("html", this.pageHTML, true);
        ...
        if (!req.attrs.isErrorPage) {
            options.themeOptions.bottomIncludes = viewParser(req, utils.getViewsPath() + '/shell/app/page_bottom', {
                page: page,
...
var renderPlugin = exports.renderPlugin = function (req, res, next) {
    var path = utils.getRootPath(), viewLib = require(utils.getLibPath()+ '/viewLibs/lib'),
...
function renderLayout(obj) {
    ...
    var path = utils.getRootPath(), themePath = theme.path, placeHolderNames = layout.placeHolderNames,
...
function parseSettingsPage(req, themePath) {
    var app = req.app;
    return {"col1HTMLTMPL": viewParser(req, utils.getViewsPath() + "/shell/app/settings/index", {})}
}
