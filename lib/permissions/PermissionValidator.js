...
function PermissionValidator(req, permissionSchemaKey, modelName) {
    ...
    this.checkPermissionForActions = function (actions, modelId, next) {
        ...
        async.series([
            function (n) {
                Cache.storeByModelId(req.app.dataSource, permissionSchemaKey, modelName, modelId, n);
            } ,
            function (n) {
    ...
    this.hasPermission = function (action, modelId, next) {
        ...
        Cache.storeByModelId(req.app.dataSource, permissionSchemaKey, modelName, modelId, function (err, done) {
            if (err) {
                return next(err);
            }
            var p;
