...
var fs = require("fs");
var PageRenderer = require("./PageRenderer"), FileUtil = require("./file/FileUtil");
...
BasePluginController.prototype.listenLoadEvent = function (handler) {
    var that = this;
    that.addDefaultPluginRoute(that);
...
BasePluginController.prototype.getFileUtil = function () {
    return FileUtil;
};
