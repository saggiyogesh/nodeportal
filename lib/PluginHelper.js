...
exports.getPluginIdAndIId = function (pluginId) {
    var pl = pluginId.split('_');
...
var populateModel = exports.populateModel = function (app, modelName, params, otherValues, keyMapObj) {
    ...
    if (!db.base.modelSchemas[modelName]) {
        ...
        require(app.set('appPath') + "/services/shell/model/" + modelName + "Schema");
    }
