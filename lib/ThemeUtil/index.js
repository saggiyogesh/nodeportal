...
exports.dockbar = function (req) {
    var app = req.app, path = utils.getViewsPath() + "/shell/app/themeHelper/dockbar.jade";
    return FileUtil.parseJadeTemplate(app, path, {req: req, PermissionValidator: PermissionValidator})
};
...
exports.pluginTools = function (req, options) {
    var app = req.app, path = utils.getViewsPath() + "/shell/app/themeHelper/plugin_tools.jade";
...
exports.setThemesStaticFolder = function (app) {
    //for default theme
    staticUtil.setStaticFolder(app, utils.getViewsPath() + '/shell/theme/');
