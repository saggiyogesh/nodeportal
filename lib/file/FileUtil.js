var util = require("util"), fs = require("fs"), fsExtra = require('fs.extra'), pathModule = require("path"),
    sep = pathModule.sep, _ = require("underscore");
...
exports.existsThenCreateDir = function (dirPath, next) {
    if (!exists(dirPath)) {
        exports.createDir(dirPath, next);
    } else {
        next && next();
    }
};
